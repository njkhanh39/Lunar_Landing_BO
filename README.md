...
It works like a "curious learner". At each iteration, the model chooses to explore a new set of params based on the UCB acquisition function, which can be a good configuration, or turns out to be terrible and crashes the ship miserably.
